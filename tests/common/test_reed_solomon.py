...
class RandomSample(object):
    """\
    RandomSample returns a set of random indexes
    for the purpose of introducing errors to data.
    """

    def __init__(self, nn: int, num_errs: int) -> None:
        """Create new RandomSample object."""
        self.nn = nn
...
class TestReedSolomon(unittest.TestCase):
    ...
    def test_prim_fcr_basic(self):
        ...
        hexencmsg = "00faa123555555c000000354064432" "c02800fe97c434e1ff5365cf8fafe4"
        strf = str
    ...
    def test_prim_fcr_long(self):
        ...
        rs = RSCodec(tt, fcr=120, prim=0x187)
        hexencmsg = (
            "08faa123555555c000000354064432c0280e1b4d090cfc04"
    ...
    def test_generator_poly(self):
        ...
        self.assertEqual(
            list(g[n - k]), list(rs_generator_poly(n - k, fcr=fcr, generator=generator))
        )
    ...
    def test_prime_poly_build(self):
        ...
        for i in range(params["count"]):
            self.assertEqual(
                find_prime_polys(
                    generator=params["generator"][i], c_exp=params["c_exp"][i]
                ),
                params["expected"][i],
            )
    ...
    def test_init_tables(self):
        ...
        """
        params = [[0x11D, 2, 8], [0x11B, 3, 8], [0xFD, 3, 7]]
        expected = [
            [
                [
                    0,
        ...
        for i, _ in enumerate(params):
            ...
            log_t, exp_t, field_charac_t = init_tables(
                prim=p[0], generator=p[1], c_exp=p[2]
            )
        ...
        for p in range(params["count"]):
            ...
            for case in cartesian_product_dict_items(cases):
                ...
                try:
                    ...
                    results_br.append(
                        rs_check(rmes + recc, n - k, fcr=fcr, generator=generator)
                    )
                ...
                try:
                    rmes, recc = rs_correct_msg_nofsynd(
                        rmesecc,
                        n - k,
                        fcr=fcr,
                        generator=generator,
