...
class TestDecryptAssemblyPacket(TFCTestCase):
    ...
    def test_expired_harac_raises_se(self) -> None:
        ...
        self.assert_se("Warning! Received packet from Alice had an expired hash ratchet counter.",
                       decrypt_assembly_packet, packet, *self.args)

    @mock.patch('builtins.input', return_value='No')
    def test_harac_dos_can_be_interrupted(self, _: Any) -> None:
...
class TestPacket(TFCTestCase):
    ...
    def test_missing_start_packet_raises_se(self) -> None:
        ...
        for header in [M_A_HEADER, M_E_HEADER]:
            self.assert_se("Missing start packet.", packet.add_packet, header + bytes(PADDING_LENGTH))
    ...
    def test_compression_error_raises_se(self) -> None:
        ...
        # Test
        self.assert_se("Error: Decompression of message failed.", packet.assemble_message_packet)
    ...
    def test_decryption_error_raises_se(self) -> None:
        ...
        # Test
        self.assert_se("Error: Decryption of message failed.", packet.assemble_message_packet)
    ...
    def test_unauthorized_file_from_contact_raises_se(self) -> None:
        ...
        # Test
        for p in packets:
            self.assert_se("Alert! File transmission from Alice but reception is disabled.", packet.add_packet, p)
        self.assertEqual(packet.log_masking_ctr, 1)
    ...
    def test_disabled_file_reception_raises_fr_with_append_packet(self) -> None:
        ...
        # Test
        self.assert_se("Alert! File reception disabled mid-transfer.", packet.add_packet, packet_list[2])
    ...
    def test_invalid_long_file_header_raises_se(self) -> None:
        ...
        # Test
        self.assert_se("Error: Received file packet had an invalid header.", packet.add_packet, packet_list[0])
        self.assertEqual(packet.log_masking_ctr, 1)
    ...
    def test_long_command_compression_error_raises_se(self) -> None:
        ...
        # Test
        self.assert_se("Error: Decompression of command failed.", packet.assemble_command_packet)
        self.assertEqual(packet.log_masking_ctr, 0)
