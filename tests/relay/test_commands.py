...
from src.relay.commands import (
    add_contact,
    add_onion_data,
    change_baudrate,
    change_ec_ratio,
...
class TestRelayCommand(unittest.TestCase):
    ...
    def test_packet_reading(self, *_):
        ...
        self.assertIsNone(
            relay_command(self.queues, self.gateway, stdin_fd=1, unit_test=True)
        )
...
class TestRaceConditionDelay(unittest.TestCase):
    ...
    def test_delay(self, mock_sleep):
        ...
        self.assertEqual(
            ...
            [mock.call(LOCAL_TESTING_PACKET_DELAY), mock.call(1.0)],
        )
...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.assertEqual(
            self.queues[CONTACT_MGMT_QUEUE].get(),
            (
                RP_ADD_CONTACT_HEADER,
...
class TestAddOnionKey(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.assertEqual(
            self.queues[ONION_KEY_QUEUE].get(),
