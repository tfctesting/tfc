...
from src.common.statics    import (ACCOUNT_CHECK_QUEUE, ACCOUNT_SEND_QUEUE, COMMAND, COMMAND_DATAGRAM_HEADER,
                                   ...
                                   GROUP_MGMT_QUEUE, GROUP_MSG_ID_LENGTH, GROUP_MSG_QUEUE, INITIAL_HARAC,
                                   KDB_M_KEY_CHANGE_HALT_HEADER, KEY_MANAGEMENT_QUEUE, KEY_MGMT_ACK_QUEUE,
                                   LOCAL_KEY_DATAGRAM_HEADER, LOGFILE_MASKING_QUEUE, LOG_PACKET_QUEUE,
                                   LOG_SETTING_QUEUE, MESSAGE, MESSAGE_DATAGRAM_HEADER, MESSAGE_PACKET_QUEUE,
                                   M_A_HEADER, M_E_HEADER, M_L_HEADER, M_S_HEADER, M_TO_FLASK_QUEUE, ONION_CLOSE_QUEUE,
                                   ONION_KEY_QUEUE, PADDING_LENGTH, PRIVATE_MESSAGE_HEADER, PUB_KEY_CHECK_QUEUE,
                                   PUB_KEY_SEND_QUEUE, RELAY_PACKET_QUEUE, SENDER_MODE_QUEUE, SRC_TO_RELAY_QUEUE,
