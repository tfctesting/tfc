...
def main() -> None:
    ...
    dependency_dict = {
        ...
        CRYPTOGRAPHY:       Dependency(uid=CRYPTOGRAPHY,       stylized_name='cryptography',       pip_name='cryptography',       sub_dependencies=[CFFI, SIX],
                                       ...
                                       manual_py37_url="https://files.pythonhosted.org/packages/bd/cb/bb7534b4f3a47d183b7ea61825cf18403116bd160db4ab490c4bdfbe33e2/cryptography-2.9.1-cp35-abi3-manylinux1_x86_64.whl",
                                       manual_py38_url="https://files.pythonhosted.org/packages/6d/f1/c69d53593eb92a5e5382fa2101cd9ae861936c6a428092605b4257336171/cryptography-2.9.1-cp35-abi3-manylinux2010_x86_64.whl"),
