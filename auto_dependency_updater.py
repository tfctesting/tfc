...
def main() -> None:
    ...
    dependency_dict = {
        ...
        CRYPTOGRAPHY:       Dependency(uid=CRYPTOGRAPHY,       stylized_name='cryptography',       pip_name='cryptography',       sub_dependencies=[CFFI, SIX],
                                       ...
                                       manual_py37_url="https://files.pythonhosted.org/packages/70/d2/ae380f16d025459d282878e094518664a13a0e740cc957b1ada59590991d/cryptography-3.1.1-cp35-abi3-manylinux1_x86_64.whl",
                                       manual_py38_url="https://files.pythonhosted.org/packages/33/62/30f6936941d87a5ed72efb24249437824f6b2c953901245b58c91fde2f27/cryptography-3.1.1-cp35-abi3-manylinux2010_x86_64.whl"),
