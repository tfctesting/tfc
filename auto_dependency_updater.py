...
def main() -> None:
    ...
    dependency_dict = {
        ...
        CRYPTOGRAPHY:       Dependency(uid=CRYPTOGRAPHY,       stylized_name='cryptography',       pip_name='cryptography',       sub_dependencies=[CFFI, SIX],
                                       ...
                                       manual_py37_url="https://files.pythonhosted.org/packages/dc/5e/e1e6991a841a9e88eb848634026199fa92665ae792ee6362a0cfa0ece3dc/cryptography-2.9-cp35-abi3-manylinux1_x86_64.whl",
                                       manual_py38_url="https://files.pythonhosted.org/packages/8f/2d/29d2638b8df016526182594166c220913dafba3da0019b0776ff1bbc8ede/cryptography-2.9-cp35-abi3-manylinux2010_x86_64.whl"),
